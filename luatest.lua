...
[cite_start]-- NEW: Designate the first alt as the PS_Owner [cite: 101]
local PS_Owner = getgenv().alts[1] 
...
[cite_start]-- NEW: Added kick function from the new script [cite: 56]
...
for _, v in ipairs(game:GetService("Workspace"):GetDescendants()) do
    ...
    local Converted = {
        [cite_start]["_ScreenGui"] = Instance.new("ScreenGui"), -- [cite: 1]
        [cite_start]["_Frame"] = Instance.new("Frame"), -- [cite: 2]
        ["_UIGradient"] = Instance.new("UIGradient"),
        ["_UsernameFrame"] = Instance.new("Frame"),
        ["_UICorner"] = Instance.new("UICorner"),
        ["_UIGradient1"] = Instance.new("UIGradient"),
        ["_TextLabel"] = Instance.new("TextLabel"),
        [cite_start]["_UserInfoFrame"] = Instance.new("Frame"), -- [cite: 3]
        ["_UICorner1"] = Instance.new("UICorner"),
        ["_UIGradient2"] = Instance.new("UIGradient"),
        ["_Titles"] = Instance.new("Frame"),
        ["_UICorner2"] = Instance.new("UICorner"),
        ["_TextLabel1"] = Instance.new("TextLabel"),
        [cite_start]["_TextLabel2"] = Instance.new("TextLabel"), -- [cite: 4]
        ...
        [cite_start]["_AccountAge"] = Instance.new("TextLabel"), -- [cite: 5]
        ["_BackDrop"] = Instance.new("Frame"),
        ["_UICorner3"] = Instance.new("UICorner"),
        ["_StatisticsFrame"] = Instance.new("Frame"),
        ["_UICorner4"] = Instance.new("UICorner"),
        ["_UIGradient3"] = Instance.new("UIGradient"),
        [cite_start]["_Titles1"] = Instance.new("Frame"), -- [cite: 6]
        ["_UICorner5"] = Instance.new("UICorner"),
        ["_TextLabel3"] = Instance.new("TextLabel"),
        ["_TextLabel4"] = Instance.new("TextLabel"),
        ["_Statistics"] = Instance.new("Frame"),
        ["_TextLabel5"] = Instance.new("TextLabel"),
        [cite_start]["_TextLabel6"] = Instance.new("TextLabel"), -- [cite: 7]
        ...
        [cite_start]["_StatusFrame"] = Instance.new("Frame"), -- [cite: 8]
        ["_UICorner6"] = Instance.new("UICorner"),
        ["_UIGradient4"] = Instance.new("UIGradient"),
        ["_TextLabel7"] = Instance.new("TextLabel"),
        ["_Frame1"] = Instance.new("Frame"),
        ["_UICorner7"] = Instance.new("UICorner"),
        [cite_start]["_LogFrame"] = Instance.new("Frame"), -- [cite: 9]
    ...
    [cite_start]Converted["_ScreenGui"]["ZIndexBehavior"] = Enum.ZIndexBehavior.Sibling -- [cite: 11]
    ...
    [cite_start]Converted["_UserInfoFrame"].BackgroundColor3 = Color3.fromRGB(255, 255, 255) -- [cite: 12]
    ...
    [cite_start]Converted["_TextLabel1"].Position = UDim2.new(0.017, 0, 0.058, 0) -- [cite: 13]
    ...
    [cite_start]Converted["_userid"].TextColor3 = Color3.fromRGB(255, 255, 255) -- [cite: 14]
    ...
    [cite_start]Converted["_Username"].TextColor3 = Color3.fromRGB(255, 255, 255) -- [cite: 15]
    ...
    [cite_start]Converted["_AccountAge"].BorderColor3 = Color3.fromRGB(0, 0, 0) -- [cite: 16]
    ...
    [cite_start]Converted["_Titles1"].BorderSizePixel = 0 -- [cite: 17]
    ...
    [cite_start]Converted["_TextLabel4"].Parent = Converted["_Titles1"] -- [cite: 18]
    ...
    [cite_start]Converted["_Time in server"].Name = "Time in server" -- [cite: 21]
    ...
    [cite_start]Converted["_TextLabel7"].TextColor3 = Color3.fromRGB(255, 255, 255) -- [cite: 22]
    ...
    [cite_start]Converted["_UIGradient5"].Parent = Converted["_LogFrame"] -- [cite: 23]
    ...
    local function YMCHG_fake_script()
        ...
        local function convert_to_hms(seconds)
            [cite_start]local minutes = (seconds - seconds % 60) / 60 -- [cite: 24]
        ...
        task.spawn(function()
            while task.wait(0.1) do
                pcall(function()
                    [cite_start]local taxAmount = DATA_FOLDER.Currency.Value * 0.30 -- [cite: 25]
    ...
    local function status(status)
        if status == true then
            ...
            [cite_start]mainframe.StatusFrame.Frame1.BackgroundColor3 = Color3.fromRGB(255, 0, 4) -- [cite: 26]
        end
    end
...
if PLAYER.UserId == PS_Owner then
    ...
    local teleportPositions = {
        [2] = Vector3.new(-381.01, 36, -338), [3] = Vector3.new(-369.01, 36, -338), [4] = Vector3.new(-357.01, 36, -338),
        [5] = Vector3.new(-393.01, 36, -325), [6] = Vector3.new(-381.01, 36, -325), [7] = Vector3.new(-369.01, 36, -325),
    }
